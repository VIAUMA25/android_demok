package hu.bme.aut.android.tododemo.ui.screen
...
import hu.bme.aut.android.tododemo.data.TodoItem
import hu.bme.aut.android.tododemo.data.TodoPriority
...
fun PreviewTodoCard() {
    TodoCard(
    todoItem = TodoItem("id","title","desc","2025.02.20",TodoPriority.NORMAL,false),
    onTodoCheckChange = {},
    onRemoveItem = {}
    )
}